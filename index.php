         ...
         <div id="topbar">
            <div class="line">
               <div class="s-12 m-6 l-6">
                  <p> <strong>info@bitwirex.io</strong></p>
               </div>
               <div class="s-12 m-6 l-6">
      ...
      <section>
         ...
         <div id="first-block">
            <div class="line">
               ...
               <p> Bitwire exchange is an initiated project. Compiling of 16 world currencies and enables you to trade in each and every currency you want to. Bitwire - X has the best UX and Functioning with an upgraded UI which enables us to serve the best to  our customers within phrase of a time.</p>
         ...
         <div id="features">
            <div class="line">
              <h1 class="whyhead">WHY BITWIRE-X ?</h1>
               <div class="margin">
                  ...
                  <div class="s-12 m-6 l-4 margin-bottom">
                     ...
                     <p>Our technology offers instant wallet to wallet transactions among BITWIRE-X users.</p>
         ...
         <div id="services">
            <div class="line">
               ...
               <div class="margin">
                  <div class="s-12 m-6 l-444 margin-bottom">
                     ...
                     <div class="our-curr">
                        <div class="curr-name">INRW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">

                        <div class="our-curr">
                       <div class="curr-name">AUDW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">

                     <div class="our-curr">
                        <div class="curr-name">SEKW</div>
                   ...
                   <div class="s-12 m-6 l-444 margin-bottom">
                     ...
                     <div class="our-curr">
                      <div class="curr-name">EURW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">

                     <div class="our-curr">
                      <div class="curr-name">BRLW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">

                     <div class="our-curr">
                      <div class="curr-name">GBPW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">

                     <div class="our-curr">
                      <div class="curr-name">JPYW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">

                     <div class="our-curr">
                      <div class="curr-name">CADW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">

                     <div class="our-curr">
                      <div class="curr-name">TRYW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">

                     <div class="our-curr">
                      <div class="curr-name">RUBW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">

                     <div class="our-curr">
                      <div class="curr-name">MXNW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">

                     <div class="our-curr">
                      <div class="curr-name">CZKW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">

                     <div class="our-curr">
                      <div class="curr-name">NZDW</div>
                     </div>
                  </div>
                  <div class="s-12 m-6 l-444 margin-bottom">
          ...
          <p class="about_desc">
            Bitwire-x.io is the perfect place for you to buy and sell Digital Assets. Trade easily and securely with Bitwire-x.io with no worry—we’ve got your back!
            ...
            <div class="line">
               ...
               <div class="margin">
                  ...
                  <div class="s-12 m-12 l-4 margin-bottom right-align">
                     <h3>BITWIRE EXCHANGE</h3>
                     <p align="justify">Bitwire exchange is an initiated project.
      ...
      <footer>
         <div class="line">
            <div class="s-12 m-6 l-5 margin-bottom">
              <img src="images/footer.png" alt="bitwire-x" width="78px">
              <p>Copyright 2017, Bitwire-X </p>
            </div>
            <div class="s-12 m-6 l-5 margin-bottom">
               <i class=""></i>
               <h3>Platform</h3>
               ...
               <div class="service-text">
                  <h3>Service</h3>
                   <ul class="footer-nav">
                     ...
                     <li><a href="#">Trader: service@bitwire-x.io</a></li>
                     <li><a href="#">Business: business@bitwire-x.io</a></li>
